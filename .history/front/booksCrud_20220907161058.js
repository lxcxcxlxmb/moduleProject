        ...
        .then((response) => {
            if (response.status === 200) {
                ...
                data.forEach(element => {
                    ...
                    trHTML += '<td>' + element.category_id + '</td>';
...
const showBookCreateBox = () => {
    Swal.fire({
        ...
        html:
            ...
            '<input id="category_id" class="swal2-input" placeholder="Category">' +
...
const showBookEditBox = async (id) => {
    ...
    Swal.fire({
        ...
        html:
            ...
            '<input id="category_id" class="swal2-input" placeholder="Category" value="' + data.category_id + '">' +
