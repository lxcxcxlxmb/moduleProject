        ...
        .then((response) => {
            if (response.status === 200) {
                ...
                data.forEach(element => {
                    ...
                    trHTML += '<td>' + element.category + '</td>';
                    trHTML += '<td>' + element.publisher + '</td>';
...
const showBookEditBox = async (id) => {
    ...
    Swal.fire({
        ...
        html:
            ...
            '<input id="category" class="swal2-input" placeholder="Category" value="' + data.category + '">' +
            '<input id="publisher" class="swal2-input" placeholder="Publisher" value="' + data.publisher + '">',
        focusConfirm: false,
        showCancelButton: true,
        preConfirm: () => {
            bookEdit();
